...
export default function TicketCardCompra({...props}) {
    return (
        <Flex direction={{sm:"column", md:"column", base:"column", lg:"row"}} height={{base:390,md:390,lg:200}} borderRadius={20} borderWidth={1}>
            <Flex flex={0.2}>
                {props.disponibilidad === true ? 
                <Flex borderLeftRadius={20}  borderRightRadius={{base:20, md:20, lg:0}} h={'full'} w={"full"}  background={"black"} direction={'column'} textAlign={"center"} justifyContent={"center"}>
                ...
                :
                <Flex borderLeftRadius={20} borderRightRadius={{base:20, md:20, lg:0}} h={'full'} w={"full"}  background={"#E10B33"} direction={'column'} textAlign={"center"} justifyContent={"center"}>
                <Text fontFamily={'Montserrat'} fontWeight={'bold'} textColor={'white'} fontSize={"3xl"}> {props.mes}</Text>
                <Text fontFamily={'Montserrat'} fontWeight={'regular'} textColor={'white'}fontSize={"2xl"}>{props.dia}</Text>
            </Flex>}
            </Flex>
            ...
            <Flex  direction={{base:"column", md:"row"}} flex= {0.8} mt={{base:'10',md:'0'}}>
                <Flex   direction={"column"} marginTop={"auto"} marginBottom={"auto"} flex={{base:'0.5',md:'0.65'}}>
                        ...
                        <IoTimeOutline size={30}/>
                            <Text  fontFamily={'Montserrat'} marginTop={'auto'} marginBottom={'auto'} ml={2}  fontWeight={"bold"}>Hora: &nbsp;</Text>
                        ...
                        <Flex mt={5} marginLeft={5} textAlign={'center'}>
                            ...
                            <Text fontFamily={'Montserrat'} marginTop={'auto'} marginBottom={'auto'} ml={2} fontWeight={"bold"}>Precio: &nbsp;</Text>
                            <Text fontFamily={'Montserrat'} marginTop={'auto'} marginBottom={'auto'}> Desde {props.precio}€</Text>
                        </Flex>
