...
export default function TicketCard({...props}) {
    ...
    return (
        <Box role={"group"} maxW={(1280/5) - 12 - 16/4} w={(1280/5) - 12 - 16/4} h={ALTURA_TICKET + 20 + "px"} mt={"10px"} {...props}>
                <Flex w={"100%"} flex={1} position={"relative"} h={ALTURA_TICKET + "px"} borderRadius={16} overflow="hidden">
                    ...
                    <Flex w={"100%"} flex={1} position={"relative"} h={ALTURA_TICKET + "px"} bg={Colors.secondary.gray} borderRadius={16} overflow="hidden">
                        ...
                        {props.isLoaded ? <Box position={"absolute"} borderTopRadius={0} overflow={"hidden"} w={"full"} h={"45%"} top={"55%"} bg={'rgba(' + (state.r) + ',' + (state.g) + ',' + (state.b) + ')'}/> : null}
                                ...
                                <Flex flex={1} w={"full"} h={"45%"}>
                                    <Flex direction={"column"} pb={"10px"} px={"10px"} flex={1}>
                                        <Flex direction={"column"} flex={1} alignItems={"left"} justifyContent={"center"}>
                                            ...
                                            <Text color={"white"} fontWeight={"bold"} fontSize={20} mb={"0px"} mt={"-2px"} fontFamily={"Montserrat"} textAlign='left' noOfLines={1}>{props.titulo}</Text>
                                            <Flex alignItems={"center"} justifyContent={"left"}>
